...
/**
 * The main tinychat configuration form
 *
 ...
 */
class mod_tinychat_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('tinychatname', 'tinychat'), array('size'=>'64'));
        ...
        $mform->addHelpButton('name', 'tinychatname', 'tinychat');
